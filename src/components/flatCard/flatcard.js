...
function Flatcard() {
  ...
  return (
    <Paper sx={{  backgroundColor:"#F9F9FA",marginTop:{xs:"950px", md:"200px"}, boxShadow:"none", border:"none" }}>
    <Container maxWidth='lg'>

    <Box sx={{ flexGrow: 1, display:{xs:"none", md:"block"}, marginTop:"100px", backgroundColor:"#F9F9FA", boxShadow:"none", border:"none" }}>
      
        <Typography variant="h2" sx={{color:"#213342", paddingTop:"50px", textAlign:"center",fontSize:{md:"35px", xs:'32px'}, fontWeight:"400", marginBottom:"50px"}}>Последняя добавленная недвижимость </Typography>
      ...
      <Grid container spacing={2}>
        ...
        <Grid item xs={4} md={4} sx={{"&:hover":{backgroundColor:"white",borderRadius:"10px", cursor:"pointer",boxShadow: "rgba(17, 17, 26, 0.05) 0px 4px 16px, rgba(17, 17, 26, 0.05) 0px 8px 32px;"}}} >
            <Box> 
                <Card sx={{backgroundImage:`url("${flat2}")`, width:"360px", height:"270px", backgroundPosition:"center center", backgroundRepeat:"no-repeat", backgroundSize:"cover" }}>
    ...
    <Typography variant="h3" sx={{color:"#213342", paddingTop:"50px",display:{md:"none",xs:"flex"}, textAlign:"center",fontSize:{md:"35px", xs:'22px'}, fontWeight:"400", marginBottom:"50px"}}>Последняя добавленная недвижимость </Typography>
...
<PaidOutlinedIcon sx={{color:"red", marginRight:"10px"}} />  {images[activeStep].label4}
    ...
    <Button variant="contained" color="warning" sx={{backgroundColor:"#E31F26",textSize:"16px", width:"100%",height:"40px", marginTop:"20px", display:{md:"none", xs:"block"}}}> Полный каталог недвижимости</Button>

    <Button variant="outlined" color="error"  sx={{textSize:"16px", display:{md:"none", xs:"block"}, width:"100%",height:"40px", marginTop:"20px"}}> Аналитика цен за 1 кв.м. <img src={analitik} alt="" /> </Button>
